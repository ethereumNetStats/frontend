import { transactionDetail } from '../../../../types/chartDataType'
...
export default function NewLatestTransactions(props: {
  ...
  const [tableTransactionData, setTableTransactionData] = useState<
    Array<RowObj>
  >([])

  useEffect(() => {
    const updatedTableTransactionData: Array<RowObj> = props.latestData
      .map((transactionData) => ({
